...
class ConnectionDisplay(QFrame, Ui_ConnectionWidget, SessionHandler):
    ...
    def setControlsEnabled(self, connect, disconnect):
        ...
        self.clientIdSpin.setEnabled(connect)
        self.portNumberSpin.setEnabled(connect)
        self.hostNameEdit.setEnabled(connect)
        self.requestAccount.setEnabled(connect)
        self.requestOrders.setEnabled(connect)
        self.requestTickers.setEnabled(connect)
